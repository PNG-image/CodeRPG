...
var theory = ['logic and math', 'more arrows', 'throwing']
var functions = ['attack', 'defend', 'parry'];
var logic_and_math = ['booleans', 'logic operators', 'math', 'advanced math', 'and, or, not', 'if', 'else', 'closestEnemy'];
var projectiles = ['arrow', 'flaming arrow', 'freexing arrow', 'poison arrow', 'knife'];
var throwable = ['dynamite', 'landmine', 'fireball', 'goo'];
var options = [];
